...
During class, we defined a set of questions we would like to ask Gabriel to help us understand the project better. These questions aim to define the scope of the project and the techincal needs.
- Is there 1 controller for all the phones?
- What kind of controlled do you want ?
